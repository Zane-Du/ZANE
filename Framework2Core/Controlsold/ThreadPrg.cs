...
namespace Framework2Core {
    ...
    public partial class ThreadPrg : UserControl {
        ...
        public ThreadPrg() {
            ...
            // 使用控件数组，引用一系列控件
            _nums = new Label[] { lbl0, lbl1, lbl2, lbl3, lbl4, lbl5, lbl6, lbl7, lbl8, lbl9,lbl10, lbl11, lbl12, lbl13, lbl14 };
            _prgs = new ProgressBar[] { prg0, prg1, prg2, prg3, prg4, prg5, prg6, prg7,prg8, prg9, prg10, prg11, prg12, prg13, prg14 };
            _states = new Label[] { lblState0, lblState1, lblState2, lblState3, lblState4, lblState5, lblState6, lblState7, lblState8, lblState9, lblState10, lblState11, lblState12, lblState13, lblState14 };
        }
